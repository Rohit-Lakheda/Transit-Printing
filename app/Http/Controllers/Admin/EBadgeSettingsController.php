...
class EBadgeSettingsController extends Controller
{
    ...
    public function update(Request $request)
    {
        $validated = $request->validate([
            ...
            'auto_send_email_on_api_registration' => 'nullable|boolean',
            'auto_send_whatsapp_on_api_registration' => 'nullable|boolean',
        ]);
        ...
        $setting->auto_send_email_on_api_registration = $request->boolean('auto_send_email_on_api_registration');
        $setting->auto_send_whatsapp_on_api_registration = $request->boolean('auto_send_whatsapp_on_api_registration');
        $setting->save();
